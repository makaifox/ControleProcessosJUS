...
<div class="container">
    ...
    <div class="card-body px-lg-5">
            ...
            <p>edite os dados abaixo 
            </p>

            <form class="text-center" style="color: #757575;" action="{{route('alterar_produto', ['id'=> $clientes->id])}}"  method="post">
            ...
            <!-- Sign in button -->
            <button class="btn btn-outline-info btn-rounded btn-block z-depth-0 my-4 waves-effect" type="submit">Editar</button>
        </form>
